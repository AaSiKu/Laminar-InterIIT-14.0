...
export const mockWorkflows = [
  {
    ...
    location: "Chicago",
    team: [
      { name: "John Smith", initials: "JS", avatar: "https://i.pravatar.cc/150?img=12" },
      { name: "Sarah Chen", initials: "SC", avatar: "https://i.pravatar.cc/150?img=5" },
      { name: "Mike Johnson", initials: "MJ", avatar: "https://i.pravatar.cc/150?img=33" },
      { name: "Emma Davis", initials: "ED", avatar: "https://i.pravatar.cc/150?img=9" },
      { name: "Alex Brown", initials: "AB", avatar: "https://i.pravatar.cc/150?img=68" },
    ],
    status: "Active",
