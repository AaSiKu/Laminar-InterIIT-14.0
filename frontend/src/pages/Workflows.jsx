...
export default function WorkflowPage() {
  ...
  }, [currentPipelineId, currentVersionId, rfInstance, setCurrentVersionId, setLoading, setError]);
  ...
  }, [currentPipelineId, currentPipelineStatus, setCurrentPipelineStatus, setLoading, setError]);
  ...
  }, [rfInstance, currentPipelineId, setCurrentPipelineId, currentVersionId, setCurrentVersionId, setError, setLoading]);
  ...
  const handleExportJSON = useCallback(() => {
    ...
    try {
      ...
      link.href = url;
      link.download = `pipeline-${pipelineId || "workflow"}-${new Date().toISOString().split("T")[0]}.json`;
  ...
  }, [rfInstance, pipelineId, currentPipelineId, currentVersionId, user, setError]);
      ...
      {!isFullscreen && (
        ...
        >
          ...
          <PipelineNavBar
            ...
            pipelineName={`Pipeline ${pipelineId ? pipelineId.toLowerCase() : "undefined"}`}
            loading={loading}
            ...
            onRunBook={() => console.log("Run Book clicked")}
