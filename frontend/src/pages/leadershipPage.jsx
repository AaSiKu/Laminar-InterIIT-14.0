...
const fetchKpiData = async () => {
  return [
    { title: 'Pipelines Running', value: '3', description: 'Currently active pipelines', icon: PipelineIcon, color: '#3b82f6' },
    { title: 'Total Pipelines', value: '6', description: 'Total deployed pipeline instances', icon: TrendingUpIcon, color: '#3b82f6' },
    { title: 'Average Runtime', value: '3.2 hrs', description: 'Mean duration per pipeline', icon: TimerIcon, color: '#3b82f6' },
    { title: 'Alerts Today', value: '5', description: 'Total alerts generated today', icon: NotificationsIcon, color: '#3b82f6' },
  ];
};
    ...
    >
      <CardContent sx={{ 
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <Typography variant="body2" color="text.secondary" fontWeight={500} sx={{ letterSpacing: '0.3px' }}>
            {title}
          </Typography>
          <Box 
            sx={{ 
          ...
          {pipelines.map((pipeline, index) => (
            <TableRow 
              ...
              sx={{
                ...
                '& > td': {
                  borderBottom: index === pipelines.length - 1 ? 'none' : '1px solid',
            ...
            >
              ...
              <TableCell>
                <Typography sx={{ fontSize: '0.875rem', color: pipeline.breachReason === '-' ? 'text.secondary' : 'text.primary' }}>
