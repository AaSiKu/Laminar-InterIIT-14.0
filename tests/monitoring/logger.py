...
connection_string= {
    ...
    "dbname": os.getenv("POSTGRES_DB", "logs"),
    "user": os.getenv("POSTGRES_USER", "this_is_mjk"),
...
class MultiEndpointLogHandler(logging.Handler):
    ...
    def __init__(
        ...
        mongo_collection: str = "important_logs",
        ...
        self.postgres_uri = postgres_uri or os.getenv(
            "POSTGRES_URI", "postgresql://postgres:postgres@localhost:5432/logs"
        )
        self.workflow_id = os.getenv("_PIPELINE_ID", "GLOBAL")
    ...
    def _connect_postgres(self):
        ...
        try:
            ...
            with self.engine.connect() as conn:
                ...
                print("Postgres - Logs Connection Done")
    ...
    def _connect_mongo(self):
        ...
        try:
            ...
            print("Mongo - Logs Connection Done")
...
def setup_logging(
    ...
    mongo_collection: str = os.getenv("MONGO_COLLECTION", "logs"),
